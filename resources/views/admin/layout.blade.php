  ...
  <nav class="red">
      <div class="nav-wrapper container ">
        ...
        <ul class="right ">                                 
            ...
            <li><a href="#" class="dropdown-trigger" data-target='dropdown2'>Olá {{session('sessionUser')->firstName}} {{session('sessionUser')->lastName}}  <i class="material-icons right">expand_more</i> </a></li>     
        </ul>
